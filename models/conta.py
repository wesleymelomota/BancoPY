...
from utels.helper import formata_float_str_moeda
...
class Conta:
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('\033[36mDeposito efetuado com sucesso\033[m')
        else:
    ...
    def sacar(self: object, valor: float) -> None:
        ...
        if valor > 0 and self.saldo_total >= valor:
            if self.saldo >= valor:
                ...
                self.saldo = 0
                self.saldo_total = self._calcula_saldo_total
            print('\033[36mSaque efetuado com sucesso\033[m')


        else:
            print('\033[31mSaque não efetuado. Tente novamente!\033[m')
    ...
    def tranferir(self: object, destino: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            if self.saldo >= valor:
                ...
                destino.saldo = destino.saldo + valor
                destino.saldo_total = destino._calcula_saldo_total
            print('\033[32mTransferencia realizada com sucesso\033[m')
        else:
            print('\033[31mTransferencia recusada. tente novamente\033[m')
